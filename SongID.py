...
def unknownCMD(update, context):
    logusr(update)
    botsend(update, context, "Sorry, I didn't understand that command.")
...
<i>We do not store more data than we need to, and delete we your uploaded audio files as soon as we've finished processing them</i>
''')
